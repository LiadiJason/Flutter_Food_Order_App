...
import 'package:fyp_test/controller/iconButton.dart';
...
class RestaurantController extends StatelessWidget {
  final RestaurantModel restaurant;
  const RestaurantController({Key key, this.restaurant}) : super(key: key);
